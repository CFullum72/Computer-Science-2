...
public:
  ...
  int     capacity      ()               const { return STRING_SIZE - 1; }; //Max chars that can be stored (not including null terminator)
 ...
 String  substr        (int, int)                const;  //The sub-string from staring position to
